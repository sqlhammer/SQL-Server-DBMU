/*
PROCEDURE:		[IndexMaint].[usp_EnableConfig]
AUTHOR:			Derik Hammer
CREATION DATE:	10/16/2013
DESCRIPTION:	This procedure is used to enable IndexMaint feature level configurations.
...
*/
CREATE PROCEDURE [IndexMaint].[usp_EnableConfig]
	@OptionID int,
