/*
PROCEDURE:		[DiskCleanup].[usp_EnableConfig]
AUTHOR:			Derik Hammer
CREATION DATE:	10/16/2013
DESCRIPTION:	This procedure is used to enable DiskCleanup feature level configurations.
...
*/
CREATE PROCEDURE [DiskCleanup].[usp_EnableConfig]
	@OptionID int,
