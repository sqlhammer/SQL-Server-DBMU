/*
PROCEDURE:		[Trace].[usp_DisableConfig]
AUTHOR:			Derik Hammer
CREATION DATE:	10/16/2013
DESCRIPTION:	This procedure is used to disable Trace feature level configurations.
...
*/
CREATE PROCEDURE [Trace].[usp_DisableConfig]
	@OptionID int,
