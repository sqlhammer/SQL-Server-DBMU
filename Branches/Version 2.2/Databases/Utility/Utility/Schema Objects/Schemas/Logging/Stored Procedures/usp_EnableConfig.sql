/*
PROCEDURE:		[Logging].[usp_EnableConfig]
AUTHOR:			Derik Hammer
CREATION DATE:	10/16/2013
DESCRIPTION:	This procedure is used to enable Logging feature level configurations.
...
*/
CREATE PROCEDURE [Logging].[usp_EnableConfig]
	@OptionID int,
